...
<ul style="list-style-type:disc">
  <li><b>University of Lodz Park Area</b> is a <b>Spring Boot application</b> covering important and useful features related to managing parking areas, park check-ins and check-outs for drivers, user management, and vehicle management.</li> 
  <li>
    <b>Roles:</b>
    <ul>
...
```sh
$ cd TP_34_sego/uni_lodz_park_area
$ docker-compose up -d
```
...
```
https://hub.docker.com/repository/docker/mehmetseyhmus/unilodzpark/general
```
